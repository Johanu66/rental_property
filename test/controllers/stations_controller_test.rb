...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { property_id: @station.property_id, railway_name: @station.railway_name, station_name: @station.station_name, walk_minutes: @station.walk_minutes } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { property_id: @station.property_id, railway_name: @station.railway_name, station_name: @station.station_name, walk_minutes: @station.walk_minutes } }
